...
(function () {
  ...
  function renderTimeline(chatParsed, pgRecords, mappa, opts) {
    ...
    function appendGhostPlaceholder(sprite, variant) {
      const shape = GHOST_SHAPES[variant] || GHOST_SHAPES.humanoid;
      ...
      path.setAttribute('stroke-width', variant === 'humanoid' ? '4' : '1');
